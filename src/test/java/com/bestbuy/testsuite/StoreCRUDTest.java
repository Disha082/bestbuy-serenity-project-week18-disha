...
public class StoreCRUDTest extends TestBase {
    static String name = "XYname" + TestUtils.getRandomValue();
    static String type = "XUtype" + TestUtils.getRandomValue();
    static String address = "London";
    static String address2 = "Ujy";
    ...
    public void test04_updateNewStore(){
        name = "TY" + TestUtils.getRandomString();
        type = "VYtype" + TestUtils.getRandomValue();
